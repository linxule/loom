...
Research Memex 通过"[清醒选择框架](https://research-memex.org/introduction/core-principles)"将这一原则落到实处。在委托任何任务给 AI 之前，先问自己三个问题：这能帮助我更好、更深入地思考吗？这会发展我的研究能力吗？我能否对 AI 的输出进行辩护、修改和扩展，并使其真正成为我自己的智力贡献？这些问题让你始终掌握研究者的主动权。在有意识的合作中，AI 增强了你的能力，而你则保留了最终的判断权。

## Research Memex 内部：有什么

[第三讲复制实验](https://research-memex.org/case-studies/systematic-reviews/session-3-human-vs-ai-synthesis)展示了有趣的发现。学生给 AI 已发表的系统性综述作为蓝图，设计协议来复制专家的认知过程，然后比较输出。AI 在全面覆盖与模式识别上很拿手。但理论创新、发现文献里那些有张力、能出新问题的缝隙？这需要人类专长来正确引导。正如 Erkko 观察我们工作时所说：通过 AI 可以进行复杂的分析操作，但人类判断在引导它们方面仍然关键。这就是"第三空间"（[LOOM V](https://threadcounts.substack.com/p/loom-v-the-third-space)）的活生生体现。
